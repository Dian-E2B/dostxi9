                            ...
                            <table id="thisdatatable" class="table-striped compact display nowrap" style="width:100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            Status As Of End Of 2nd Semester 2021 2022
                                        </th>
                                        <th>Remarks</th>
                                        <th>Gender</th>
                                    </tr>
                                ...
                                <tbody>
                                    @foreach ($rsmsra10612 as $rsmsra106121)
                                        <tr>
                                            <td> {{ $rsmsra106121->No }}</td>
                                            <td style="padding: 0 20px;">{{ $rsmsra106121->YearOfAward }}</td>
                                            <td>{{ $rsmsra106121->Name }}</td>
                                            <td style="padding: 0 20px;">{{ $rsmsra106121->LevelOrYear }}
                                            </td>
                                            <td>{{ $rsmsra106121->School }}</td>
                                            <td style="padding: 0 20px">{{ $rsmsra106121->Course }}</td>
                                            <td style="padding: 0 35px">{{ $rsmsra106121->SemOrTriOrQtrStarted }}</td>
                                            <td style="padding: 0 25px">{{ $rsmsra106121->CourseDuration }}</td>
                                            <td>{{ $rsmsra106121->StatusAsOfEndOf2ndSemester20212022 }}</td>
                                            <td>{{ $rsmsra106121->Remarks }}</td>
                                            <td>{{ $rsmsra106121->Gender }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
