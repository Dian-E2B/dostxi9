                    ...
                    <div class="container-fluid p-0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="thisdatatable" class="table-striped compact display nowrap"
                                    style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            ...
                                            <th>
                                                Satus As Of End Of 2nd Semester 2021 2022
                                    ...
                                    <tbody>
                                        @foreach ($rsmsra7687 as $rsmsra76871)
                                            <tr>
                                                <td> {{ $rsmsra76871->NO }}</td>
                                                <td style="padding: 0 20px;">{{ $rsmsra76871->YearOfAward }}</td>
                                                <td>{{ $rsmsra76871->Name }}</td>
                                                <td style="padding: 0 20px;">{{ $rsmsra76871->LevelOrYear }}
                                                </td>
                                                <td>{{ $rsmsra76871->School }}</td>
                                                <td style="padding: 0 20px">{{ $rsmsra76871->Course }}</td>
                                                <td style="padding: 0 35px">{{ $rsmsra76871->SemOrTriOrQtrStarted }}
                                                </td>
                                                <td style="padding: 0 10px">{{ $rsmsra76871->CourseDuration }}</td>
                                                <td>{{ $rsmsra76871->SatusAsOfEndOf2ndSemester20212022 }}</td>
                                                <td>{{ $rsmsra76871->Remarks }}</td>
                                                <td>{{ $rsmsra76871->Gender }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
