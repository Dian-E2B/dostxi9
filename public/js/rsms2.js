var startyearValue = $('#startyear').val();
        ...
        $(document).ready(function($) {
            ...
            $(document).on('click', '.edit-btn', function() {
                var number = $(this).data('number');
                $.ajax({
                    url: retrieveongoing + '/' + number + '/' + semesterValue + '/' + startyearValue,
                    method: 'GET',
        ...
        $.extend(true, $.fn.dataTable.defaults, {
            ...
            buttons: [{
                    ...
                    title: 'ON-GOING SCHOLARS MONITORING CHECKLIST ' + semesterValue + ' AY ' + startyearValue + '-' + endyearValue,
                    exportOptions: {
                    ...
                    customize: function(win) {
                        ...
                        if (win.document.body.innerHTML.indexOf('<img id="logo"') === -1) {
                            $(win.document.body).prepend(thislogo);
                        }
                        $(win.document.body)
                            .css('font-size', '36pt')
                            .find('td')
